...
# Note that twistToAckermannDrive needs to be mapped to the robot_control/command parameter in the command line ie. rosrun eufsa_robot_control twist_to_ackermannDrive.py twistToAckermannDrive:=eufsa_robot_control/command
...
class Convert:
    def __init__(self):
        self.publisher = rospy.Publisher('twistToAckermannDrive', AckermannDriveStamped, queue_size=10)
        self.max_steering = math.radians(29)
        self.min_steering = math.radians(-29)
